...
wget -O thermos_${VERSION}.orig.tar.bz2 https://gitlab.com/striezel/thermos/-/archive/${COMMIT_HASH}/thermos-${COMMIT_HASH}.tar.bz2
tar -x --bzip2 -f thermos_${VERSION}.orig.tar.bz2
if [[ $? -ne 0 ]]
then
...
mv thermos-${COMMIT_HASH} thermos-${VERSION}
if [[ $? -ne 0 ]]
then
...
mv thermos*.deb thermos_${VERSION}-${RELEASE}_${ARCH}.deb
